...
function StepProgressBar(props) {
  ...
  return createElement("div", {
    ...
    return createElement("li", {
    ...
    }, step.state === StepStates.COMPLETED && createElement("a", {
      ...
      stroke: "white",
      strokeWidth: "1.5"
    }))), step.state === StepStates.ERROR && createElement("a", {
      className: styles['step-icon'],
      onClick: nextHandler
    }, "!"), step.state !== StepStates.COMPLETED && step.state !== StepStates.ERROR && createElement("a", {
