...
function StepProgressBar(props) {
  ...
  function test() {
    console.log("we have clicked on a step");
  }
  ...
  return React.createElement("div", {
    ...
    return React.createElement("li", {
    ...
    }, step.state === StepStates.COMPLETED && React.createElement("a", {
      ...
      stroke: "white",
      strokeWidth: "1.5"
    }))), step.state === StepStates.ERROR && React.createElement("a", {
      className: styles['step-icon'],
      onClick: nextHandler
    }, "!"), step.state !== StepStates.COMPLETED && step.state !== StepStates.ERROR && React.createElement("a", {
