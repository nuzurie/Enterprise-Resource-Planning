...
public class PDFReport {
    ...
    private static Font subFont = new Font(Font.FontFamily.COURIER, 16,
            Font.BOLD);
    private static Font regularFont = new Font(Font.FontFamily.COURIER, 12,
            Font.NORMAL);
...
//            addMetaData(document);
    ...
    private static void addContent(Document document) throws DocumentException {
        Anchor anchor = new Anchor("First Chapter", header1Font);
        ...
        // Next section
        anchor = new Anchor("Second Chapter", header1Font);
